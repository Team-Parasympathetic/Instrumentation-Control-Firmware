...
#define FPGA_EVENT_REG_CHECKSUM          0x021CU
...
#define FPGA_ACTION_REG_CHECKSUM         0x0240U
...
#define FPGA_CHANNEL_MODE_MIRROR_SYNC    0x04U

#define FPGA_CHANNEL_FLAG_POLARITY_INV   0x08U
#define FPGA_CHANNEL_FLAG_IDLE_HIGH      0x10U
